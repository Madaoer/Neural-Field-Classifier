...
class RGBRenderer(nn.Module):
    ...
    def combine_rgb(
        ...
        comp_rgb = torch.sum(comp_rgb.reshape(-1, 3, 8) * class_weight  / class_weight.sum(), dim=-1)
    ...
    def forward(
        ...
        rgb = self.combine_rgb(
            rgb, weights, background_color=self.background_color, ray_indices=ray_indices, num_rays=num_rays, class_weight=self.class_weight
        )
